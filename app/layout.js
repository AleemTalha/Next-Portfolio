...
export default function RootLayout({ children }) {
  ...
  const canonical = `https://aleemtdev.vercel.app${
    pathname === "/" ? "" : pathname
  }`;
  ...
  return (
    <html lang="en">
      <head>
        ...
        <meta
          name="description"
          content="Full Stack Developer Portfolio of Aleem T.dev(Talha Aleem). Explore modern web development projects, skills, and contact information. Hire Aleem T.dev for your next project. See all projects, blogs, and contact details."
        />
        ...
        <meta
          name="author"
          content="Talha Aleem, Aleem Talha, Aleem T Dev, Aleem T.dev, Aleem Talha Dev"
        />
        <meta
          name="robots"
        ...
        <meta
          ...
          content="Aleem Talha Dev Portfolio"
        />
        <meta
          property="og:alternate_title"
        ...
        <meta
          property="og:image"
          content="https://aleemtdev.vercel.app/aleem.jpg"
        />
        <meta
          property="og:image:alt"
          content="Talha Aleem, Aleem Talha, Aleem T.dev - Portfolio Picture"
        />
        ...
        <meta
          ...
          content="https://github.com/TalhaAleem098"
        />
        <meta
          property="og:see_also"
          content="https://linkedin.com/in/aleemtdev"
        />
        <meta property="og:see_also" content="https://twitter.com/talhaaleem" />
        <meta
          property="og:see_also"
          content="https://www.instagram.com/archon_aleem?igsh=dmVpcmJsdXB4ZW1k"
        />
        <meta
          property="og:see_also"
          content="https://www.facebook.com/share/1APJA1pbao/"
        />
        {/* Twitter Card Meta Tags */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta
          name="twitter:title"
          content="Aleem T.Dev | Mern Stack and Next.js Developer"
        />
        <meta
        ...
        <link
          rel="me"
          href="https://www.instagram.com/archon_aleem?igsh=dmVpcmJsdXB4ZW1k"
        />
            ...
            __html: JSON.stringify({
              ...
              urlLinks: [
                ...
                },
                {
                  "@type": "WebPage",
                  name: "Blogs",
                  url: "https://aleemtdev.vercel.app/blogs",
                },
                {
                  "@type": "WebPage",
                  name: "Contact",
                  url: "https://aleemtdev.vercel.app/contact",
                },
                {
                  "@type": "WebPage",
                  name: "About",
                  url: "https://aleemtdev.vercel.app/about",
                },
              ],
            }),
          }}
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              description:
                "A showcase of web development and full-stack projects by Talha Aleem (Aleem Talha, Aleem T.dev).",
              url: "https://aleemtdev.vercel.app/projects",
              mainEntity: {
                "@type": "Person",
                name: "Talha Aleem",
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              potentialAction: {
                "@type": "SearchAction",
                target:
                  "https://aleemtdev.vercel.app/search?q={search_term_string}",
